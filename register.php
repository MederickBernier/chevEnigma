    ...
    <div class="col s12 m12 l12">
        ...
        <form id="registerForm">
            <div class="row">
                <div class="col s12 m12 l12">
                    <div class="input-field s12 l12 m12">
                        <input placeholder="Nom d'utilisateur" id="username" type="text" class="validate" autocomplete="off" data-length="20">
            ...
            <div class="row">
                <div class="col s12 m12 l12">
                    <div class="input-field s12 l12 m12">
                        <input placeholder="Mot de Passe" id="password" type="password" class="validate" autocomplete="off" data-length="60">
            ...
            <div class="row">
                <div class="col s12 m12 l12">
                    <div class="input-field s12 l12 m12">
                        <input placeholder="Confirmation Mot de Passe" id="confirmPassword" type="password" class="validate" autocomplete="off" data-length="60">
            ...
            <div class="row">
                <div class="col s12 m12 l12">
                    <div class="input-field s12 l12 m12">
                        <input placeholder="Nom Complet" id="fullName" type="text" class="validate" autocomplete="off" data-length="70">
            ...
            <div class="row">
                <div class="col s12 m12 l12">
                    <div class="input-field s12 l12 m12">
                        <input placeholder="Adresse Courriel" id="email" type="email" class="validate" autocomplete="off" data-length="70">
